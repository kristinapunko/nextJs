...
export type Order = {
  ...
  status?: "pending" | "paid" | "shipped" | "delivered" | "cancellede";
  orderDate?: string;
};
...
export type MY_ORDERS_QUERYResult = Array<{
  ...
  currency?: string;
  amountDiscount?: number;
  status?: "cancellede" | "delivered" | "paid" | "pending" | "shipped";
  orderDate?: string;
}>;
...
export type PRODUCTS_BY_ID_QUERYResult = {
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Source: ./sanity/lib/products/getProductsByCotegory.tsx
...
// Variable: PRODUCT_SEACH_QUERY
// Query: *[            _type == "product"            && name match $searchParam            ] | order(name asc)
export type PRODUCT_SEACH_QUERYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: ACTIVE_SALE_BY_CUPON_QUERY
// Query: *[      _type == "sale"      && IsActive == true      && couponCode == $couponCode    ] | order(validForm desc)[0]
export type ACTIVE_SALE_BY_CUPON_QUERYResult = {
  _id: string;
  _type: "sale";
  _createdAt: string;
  _updatedAt: string;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "\n        *[_type == \"product\" && slug.current == $slug] | order(name asc) [0]\n    ": PRODUCTS_BY_ID_QUERYResult;
    "\n        *[\n            _type == \"product\"\n            && references(*[_type == \"category\" && slug.current == $categorySlug]._id)\n        ] | order(name asc)\n        ": PRODUCTS_BY_CATEGORY_QUERYResult;
    "\n        *[\n            _type == \"product\"\n            && name match $searchParam\n            ] | order(name asc)\n    ": PRODUCT_SEACH_QUERYResult;
    "\n    *[\n      _type == \"sale\"\n      && IsActive == true\n      && couponCode == $couponCode\n    ] | order(validForm desc)[0]\n  ": ACTIVE_SALE_BY_CUPON_QUERYResult;
  }
}
